(use-package treemacs
  ...
  (progn
	...
	(treemacs-create-icon :icon ""   :fallback "󰅲 "   :extensions ("el" "elc" "cl" "lisp"))
	(treemacs-create-icon :icon ""   :fallback " "   :extensions ("sh"))
	(treemacs-create-icon :icon ""   :fallback " "   :extensions (".gitignore" ".gitkeep" ".gitattributes"))
	...
	(treemacs-create-icon :icon ""   :fallback " "   :extensions ("go"))
	(treemacs-create-icon :icon ""   :fallback "󰗀 "   :extensions ("xml" "html"))
	(treemacs-create-icon :icon ""   :fallback " "   :extensions ("css" "scss"))
	(treemacs-create-icon :icon ""   :fallback " "   :extensions ("js"))
	(treemacs-create-icon :icon ""   :fallback " "   :extensions ("yml" "yaml"))
	(treemacs-create-icon :icon ""   :fallback "󰈟 "   :extensions ("png" "jpg" "jpeg" "svg"))
